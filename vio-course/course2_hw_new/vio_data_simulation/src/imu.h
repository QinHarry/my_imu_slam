...
public:
    ...
    void euler(const MotionData& cur, const Eigen::Quaterniond& Qwb, Eigen::Quaterniond& dq, Eigen::Vector3d& acc_w);

    void midPoint(const MotionData& prev, const MotionData& cur, const Eigen::Quaterniond& Qwb, Eigen::Quaterniond& dq, Eigen::Vector3d& acc_w);
